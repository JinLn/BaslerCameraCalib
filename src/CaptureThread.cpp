...
//		CDeviceInfo dev;
        ...
        if (!exposureuto) {
            ...
            cam.AutoExposureTimeLowerLimit.SetValue(exposureautotimemin);
            cam.AutoExposureTimeUpperLimit.SetValue(exposureautotimemax);
        }
		isOpen = true;
	}
